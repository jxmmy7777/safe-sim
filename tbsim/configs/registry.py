...
from tbsim.configs.nuplan_config import (
    NuplanTrainConfig,
    NuplanEnvConfig
)
...
EXP_CONFIG_REGISTRY["nusc_diffusion"] = ExperimentConfig(
    train_config=NuscTrainConfig(),
    env_config=NuscEnvConfig(),
    algo_config=DiffusionTrafficConfig(),
    registered_name="nusc_diffusion"    
)

EXP_CONFIG_REGISTRY["nusc_diffscene"] = ExperimentConfig(
    train_config=NuscTrainConfig(),
    env_config=NuscEnvConfig(),
    algo_config=DiffSceneConfig(),
    registered_name="nusc_diffusion"    
)
#----waymo
# ----------------- nuplan
EXP_CONFIG_REGISTRY["nuplan_diffusion"] = ExperimentConfig(
    train_config=NuplanTrainConfig(),
    env_config=NuplanEnvConfig(),
    algo_config=DiffusionTrafficConfig(),
    registered_name="nuplan_diffusion"    
)

EXP_CONFIG_REGISTRY["nuplan_diffscene"] = ExperimentConfig(
    train_config=NuplanTrainConfig(),
    env_config=NuplanEnvConfig(),
    algo_config=DiffSceneConfig(),
    registered_name="nuplan_diffscene"    
)

EXP_CONFIG_REGISTRY["closedloop_training"] = ExperimentConfig(
    train_config=NuscTrainConfig(),
    env_config=NuscEnvConfig(),
    algo_config=DiffusionTrafficConfig(),
    registered_name="closedloop_training"
)
