...
class NuplanTrainConfig(TrainConfig):
    def __init__(self):
        super(NuplanTrainConfig, self).__init__()
        ...
        self.trajdata_data_dirs = {
            # "nusc_mini": "/net/acadia10a/data/sriram/nuscenes",
            # "nusc_trainval": "path/tonuscenes",
        }
        ...
        # training config
        self.training.batch_size = 120*8
